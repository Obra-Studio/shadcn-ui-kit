<script lang="ts">
	...
	const faqItems = [
		...
		},
		{
			...
			content:
				'Figma allows you to publish libraries for use in Figma Make. If you customize your library and then publish it to work with make, Make can read your shadcn/ui customizations. Since Make uses shadcn/ui under the hood for most UI generation logic at the moment of writing (November 2025) you can use a customization of the Obra shadcn/ui kit to feed your custom design logic to make.',
		},
		{
			title: 'How do you ensure updates?',
			content:
				'Obra shadcn/ui is made by Obra Studio. We are a small design and development studio with roots in Belgium and Mexico. We have team of maintainers and freelancers helping to keep the kit in good shape and watch the shadcn/ui world.',
		},
		{
...
<div class="bg-background flex flex-col items-start w-full min-h-screen">
	...
	>
		<div class="flex items-center gap-3">
			...
			<!-- Desktop Navigation -->
			<nav class="flex items-center md:pl-8 gap-0 text-sm md:text-base">
				<a
					href="/documentation"
					class="rounded-full px-3 py-2 font-medium text-foreground tracking-[-0.32px] hover:bg-accent transition-colors"
				>
					Documentation
				</a>
				<a
  ...
  "
	...
	<!-- Footer -->
	<footer
		class="bg-muted flex flex-col gap-10 items-center px-12 py-20 w-full"
	>
		<div class="w-full">
			<p class="leading-9 mb-0 text-lg text-foreground text-center">
				Obra shadcn/ui is a completely free, high quality UI kit for
				Figma loved by over 20,000 creators.
			</p>
			<p class="leading-9 text-lg text-foreground text-center">
				See <a href="https://figma.com/@obrastudio" class="underline"
					>our Figma community profile</a
				> to download.
			</p>
		</div>
		<p class="leading-9 text-lg text-foreground text-center w-full">
			Made with ❤️ by <a href="https://obra.studio/" class="underline"
				>Obra Studio</a
			>
		</p>
	</footer>
