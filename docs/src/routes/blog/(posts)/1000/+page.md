...
Currently, we are planning to add some videos to YouTube to make it more clear how the kit can be used. Check out the existing videos [here](/documentation/videos). These videos will also serve as Figma tutorials. If you have any specific video requests, something that you wanted to know about Figma and never dared to ask, also feel free to put this in the GitHub issue. 